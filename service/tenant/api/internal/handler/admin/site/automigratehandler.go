...
func AutoMigrateHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.SiteShowReq
		...
		svcCtx.Request = r
		l := site.NewAutoMigrateLogic(r.Context(), svcCtx)
		resp := l.AutoMigrate(&req)
		httpx.OkJson(w, resp)
	}
}
