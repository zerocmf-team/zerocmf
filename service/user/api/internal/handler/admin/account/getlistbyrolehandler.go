...
func GetListByRoleHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.ListByRoleReq
		...
		l := account.NewGetListByRoleLogic(r.Context(), svcCtx)
		resp := l.GetListByRole(&req)
		httpx.OkJson(w, resp)
	}
}
