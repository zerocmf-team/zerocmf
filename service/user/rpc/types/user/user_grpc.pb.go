...
type UserClient interface {
	...
	Database(ctx context.Context, in *DatabaseRequest, opts ...grpc.CallOption) (*DatabaseReply, error)
}
...
func (c *userClient) Init(ctx context.Context, in *InitRequest, opts ...grpc.CallOption) (*InitReply, error) {
	out := new(InitReply)
	err := c.cc.Invoke(ctx, "/user.user/Init", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) ValidationJwt(ctx context.Context, in *OauthRequest, opts ...grpc.CallOption) (*OauthReply, error) {
	out := new(OauthReply)
	err := c.cc.Invoke(ctx, "/user.user/ValidationJwt", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) Database(ctx context.Context, in *DatabaseRequest, opts ...grpc.CallOption) (*DatabaseReply, error) {
	out := new(DatabaseReply)
	err := c.cc.Invoke(ctx, "/user.user/Database", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	Database(context.Context, *DatabaseRequest) (*DatabaseReply, error)
...
func (UnimplementedUserServer) Database(context.Context, *DatabaseRequest) (*DatabaseReply, error) {
...
func _User_ValidationJwt_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.user/ValidationJwt",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_Database_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DatabaseRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(UserServer).Database(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/user.user/Database",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).Database(ctx, req.(*DatabaseRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var User_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Database",
			Handler:    _User_Database_Handler,
		},
	},
