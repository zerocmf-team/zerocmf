...
func NewProductSessionModel(conn sqlx.SqlConn, session sqlx.Session, c cache.CacheConf, opts ...cache.Option) ProductModel {
	return &customProductModel{
		defaultProductModel: newProductModel(conn, c, opts...).withSession(session),
	}
}
