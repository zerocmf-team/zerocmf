...
const (
	Portal_AutoMigrate_FullMethodName = "/portal.portal/autoMigrate"
)
...
func (c *portalClient) AutoMigrate(ctx context.Context, in *SiteReq, opts ...grpc.CallOption) (*SiteReply, error) {
	out := new(SiteReply)
	err := c.cc.Invoke(ctx, Portal_AutoMigrate_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedPortalServer) AutoMigrate(context.Context, *SiteReq) (*SiteReply, error) {
...
func _Portal_AutoMigrate_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SiteReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(PortalServer).AutoMigrate(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Portal_AutoMigrate_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(PortalServer).AutoMigrate(ctx, req.(*SiteReq))
	}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _Portal_AutoMigrate_Handler,
		},
	},
