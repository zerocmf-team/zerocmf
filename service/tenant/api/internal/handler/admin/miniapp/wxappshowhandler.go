...
import (
	...
	"zerocmf/service/tenant/api/internal/logic/admin/miniapp"
	"zerocmf/service/tenant/api/internal/svc"
	"zerocmf/service/tenant/api/internal/types"
)

func WxappShowHandler(svcCtx *svc.ServiceContext) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		var req types.MiniappShowReq
		...
		l := miniapp.NewWxappShowLogic(r.Context(), svcCtx)
		resp := l.WxappShow(&req)
		httpx.OkJson(w, resp)
	}
}
