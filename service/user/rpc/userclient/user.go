...
type (
	DatabaseReply   = user.DatabaseReply
	DatabaseRequest = user.DatabaseRequest
...
func (m *defaultUser) Database(ctx context.Context, in *DatabaseRequest, opts ...grpc.CallOption) (*DatabaseReply, error) {
	client := user.NewUserClient(m.cli.Conn())
	return client.Database(ctx, in, opts...)
}
